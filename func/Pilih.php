  ...
  <div class="col-sm-6 col-md-3">
    <div class="box box-primary">
      ...
      <div class="box-footer text-center">
        ...
        <button class="ripple tombol tombol-blue" data-toggle="modal" data-target="#modal-pilih" onclick="pilih(<?=$no; ?>)">
...
<div class="row">
  <div class="col-sm-6 col-md-6">
    <div class="row left">
      <div class="col-md-6">
        <img src="assets/img/kpo.png" id="kpo" alt="" class="img-responsive">
      </div><br>
  ...
  <div class="col-sm-6 col-md-6 right" id="welcome">
    ...
    <div class="login-box" id="logBox">
      ...
      <p class="login-box-msg">Login untuk mulai memilih</p>
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-4" id="btnLogin">
            <button type="button" class="btn ripple btnLogin" style="width: 213%; color: white; background: #1c58c7" id="btn-login">Login</button>
          </div>
        </div>
      </div>
    </div>
