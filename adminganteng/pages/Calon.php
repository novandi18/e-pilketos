...
<section class="content">
  ...
  <div class="box" id="contentCalon">
    <div class="box-header">
      <button id="btn-tambah" class="tombol tombol-blue rippleBlue" style="outline: none" data-toggle="modal" data-target="#modal-form">
        <i class="fa fa-plus"></i> 
        Tambah Calon
      </button>
      <button id="hapusSemua" class="tombol tombol-red rippleRed" style="outline: none" data-toggle="modal" data-target="#modal-hapus">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="border-radius: 20px; padding: 3px; box-shadow: 1px 3px 10px rgba(000,000,000, .2);">
        ...
        <div class="modal-footer">
          <button type="button" class="tombol tombol-blue rippleBlue" id="btn-simpan">Simpan</button>
          <button type="button" class="tombol tombol-green rippleGreen" id="btn-ubah">Ubah</button>
