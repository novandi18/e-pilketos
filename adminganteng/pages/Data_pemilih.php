...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <button class="tombol rippleBlue tombol-blue"  data-toggle="modal" data-target="#modal-tambah">
        <i class="fa fa-plus"></i> 
        Tambah Data
      </button>
      <button class="tombol rippleRed tombol-red" data-toggle="modal" data-target="#modal-hapus">
