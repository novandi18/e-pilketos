...
<div class="row" id="rows">
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box" style="border-radius: 15px; box-shadow: 1px 2px 10px rgba(000,000,000, .1);">
      <span class="info-box-icon bg-aqua" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px"><i class="fa fa-bar-chart"></i></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box" style="border-radius: 15px; box-shadow: 1px 2px 10px rgba(000,000,000, .1);">
      <span class="info-box-icon bg-yellow" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px"><i class="fa fa-table"></i></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box" style="border-radius: 15px; box-shadow: 1px 2px 10px rgba(000,000,000, .1);">
      <span class="info-box-icon bg-green" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px"><i class="fa fa-check"></i></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box" style="border-radius: 15px; box-shadow: 1px 2px 10px rgba(000,000,000, .1);">
      <span class="info-box-icon bg-red" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px"><i class="fa fa-times"></i></span>
...
<div class="row">
  <div class="col-md-12">
    <div class="box" style=" box-shadow: 1px 2px 10px rgba(000,000,000, .1); border-radius: 15px; padding: 5px">
