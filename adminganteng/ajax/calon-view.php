...
<div class="col-sm-6 col-md-3">
  <div class="box box-default" id="cardCalon">
    ...
    <div class="box-footer text-center">
      <button class="tombol tombol-cyan rippleCyan" data-toggle="modal" data-target="#modal-info" onclick="info(<?=$no; ?>)">
        &nbsp;<i class="fa fa-info"></i>&nbsp;
      </button>
      <button class="tombol tombol-blue rippleBlue" data-toggle="modal" data-target="#modal-form" onclick="edit(<?=$no; ?>)">
        <i class="fa fa-edit"></i>
      </button>
      <button class="tombol tombol-red rippleRed" data-toggle="modal" data-target="#modal-hapus" onclick="hapus(<?=$no; ?>)">
